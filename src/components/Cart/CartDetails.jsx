...
import CartPic from "./../../assets/cart-item.png"
...
const CartDetails = ({ onClose }) => {
    // const { state.cartData, setstate.cartData } = useContext(MovieContext)
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <h2 className="text-2xl lg:text-[30px] mb-10 font-bold text-center">Your Carts</h2>
                    <div
                        className="space-y-8 lg:space-y-12 max-h-[450px] overflow-auto mb-10 lg:mb-14"
                    >

                        {
                            state.cartData.length === 0 ? <p>Cart is empty</p> :
